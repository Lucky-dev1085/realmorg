...
export class DetailContactComponent implements OnInit {
  ...
  request_detail() {
    this.leadsService.saveLeads("detail", this.address, this.str_first_name, this.str_last_name, this.str_email, this.str_phone, this.str_msg, this.str_type, this.str_subtype).subscribe(
      data => {
        console.log(data);
