...
const routes: Routes = [
  ...
  { path: 'Calgary/Calgary-NE', component: CalgaryNeComponent },
  { path: 'Calgary/Calgary-NW', component: CalgaryNwComponent },
  { path: 'Calgary/Calgary-SE', component: CalgarySeComponent },
  { path: 'Calgary/Calgary-SW', component: CalgarySwComponent },
  { path: 'Calgary/Calgary-S', component: CalgarySComponent },
  { path: 'Calgary/Calgary-N', component: CalgaryNComponent },
  { path: 'Calgary/Calgary-E', component: CalgaryEComponent },
  { path: 'Calgary/Calgary-W', component: CalgaryWComponent },
  { path: 'Calgary/Calgary-CC', component: CalgaryCenterComponent },

  { path: 'Calgary/Calgary-NE/Abbeydale', component: AbbeydaleComponent },
  { path: 'Calgary/Calgary-NE/Calgary-International-Airport', component: CalgaryInternationalAirportComponent },
  { path: 'Calgary/Calgary-NE/Castleridge', component: CastleridgeComponent },
  { path: 'Calgary/Calgary-NE/Cityscape', component: CityscapeComponent },
  { path: 'Calgary/Calgary-NE/Coral-Springs', component: CoralSpringsComponent },
  { path: 'Calgary/Calgary-NE/Cornerstone', component: CornerstoneComponent },
  { path: 'Calgary/Calgary-NE/Deerfoot-BusinessCentre', component: DeerfootBusinessCentreComponent },
  { path: 'Calgary/Calgary-NE/Falconridge', component: FalconridgeComponent },
  { path: 'Calgary/Calgary-NE/Franklin', component: FranklinComponent },
  { path: 'Calgary/Calgary-NE/Greenview-Industrial-Park', component: GreenviewIndustrialParkComponent },
  { path: 'Calgary/Calgary-NE/Horizon', component: HorizonComponent },
  { path: 'Calgary/Calgary-NE/Marlborough', component: MarlboroughComponent },
  { path: 'Calgary/Calgary-NE/Marlborough-Park', component: MarlboroughParkComponent },
  { path: 'Calgary/Calgary-NE/Martindale', component: MartindaleComponent },
  { path: 'Calgary/Calgary-NE/Mayland', component: MaylandComponent },
  { path: 'Calgary/Calgary-NE/Mayland-Heights', component: MaylandHeightsComponent },
  { path: 'Calgary/Calgary-NE/McCall', component: McCallComponent },
  { path: 'Calgary/Calgary-NE/Meridian', component: MeridianComponent },
  { path: 'Calgary/Calgary-NE/Monterey-Park', component: MontereyParkComponent },
  { path: 'Calgary/Calgary-NE/North-Airways', component: NorthAirwaysComponent },
  { path: 'Calgary/Calgary-NE/Pegasus', component: PegasusComponent },
  { path: 'Calgary/Calgary-NE/Pineridge', component: PineridgeComponent },
  { path: 'Calgary/Calgary-NE/Redstone', component: RedstoneComponent },
  { path: 'Calgary/Calgary-NE/Rundle', component: RundleComponent },
  { path: 'Calgary/Calgary-NE/Saddle-Ridge', component: SaddleRidgeComponent },
  { path: 'Calgary/Calgary-NE/Saddleridge-Industrial', component: SaddleridgeIndustrialComponent },
  { path: 'Calgary/Calgary-NE/Skyview-Ranch', component: SkyviewRanchComponent },
  { path: 'Calgary/Calgary-NE/South-Airways', component: SouthAirwaysComponent },
  { path: 'Calgary/Calgary-NE/Stonegate-Landing', component: StonegateLandingComponent },
  { path: 'Calgary/Calgary-NE/Stoney-3', component: Stoney3Component },
  { path: 'Calgary/Calgary-NE/Sunridge', component: SunridgeComponent },
  { path: 'Calgary/Calgary-NE/Taradale', component: TaradaleComponent },
  { path: 'Calgary/Calgary-NE/Temple', component: TempleComponent },
  { path: 'Calgary/Calgary-NE/Vista-Heights', component: VistaHeightsComponent },
  { path: 'Calgary/Calgary-NE/Westwinds', component: WestwindsComponent },
  { path: 'Calgary/Calgary-NE/Whitehorn', component: WhitehornComponent },

  { path: 'Calgary/Calgary-NW/Arbour-Lake', component: ArbourLakeComponent },
  { path: 'Calgary/Calgary-NW/Bowness', component: BownessComponent },
  { path: 'Calgary/Calgary-NW/Brentwood', component: BrentwoodComponent },
  { path: 'Calgary/Calgary-NW/Charleswood', component: CharleswoodComponent },
  { path: 'Calgary/Calgary-NW/Citadel', component: CitadelComponent },
  { path: 'Calgary/Calgary-NW/Collingwood', component: CollingwoodComponent },
  { path: 'Calgary/Calgary-NW/Dalhousie', component: DalhousieComponent },
  { path: 'Calgary/Calgary-NW/Edgemont', component: EdgemontComponent },
  { path: 'Calgary/Calgary-NW/Greenwood-Greenbriar', component: GreenwoodGreenbriarComponent },
  { path: 'Calgary/Calgary-NW/Hamptons', component: HamptonsComponent },
  { path: 'Calgary/Calgary-NW/Hawkwood', component: HawkwoodComponent },
  { path: 'Calgary/Calgary-NW/Montgomery', component: MontgomeryComponent },
  { path: 'Calgary/Calgary-NW/Ranchlands', component: RanchlandsComponent },
  { path: 'Calgary/Calgary-NW/Rocky-Ridge', component: RockyRidgeComponent },
  { path: 'Calgary/Calgary-NW/Royal-Oak', component: RoyalOakComponent },
  { path: 'Calgary/Calgary-NW/Royal-Vista', component: RoyalVistaComponent },
  { path: 'Calgary/Calgary-NW/Scenic-Acres', component: ScenicAcresComponent },
  { path: 'Calgary/Calgary-NW/Silver-Springs', component: SilverSpringsComponent },
  { path: 'Calgary/Calgary-NW/Tuscany', component: TuscanyComponent },
  { path: 'Calgary/Calgary-NW/University-District', component: UniversityDistrictComponent },
  { path: 'Calgary/Calgary-NW/University-Heights', component: UniversityHeightsComponent },
  { path: 'Calgary/Calgary-NW/Varsity', component: VarsityComponent },

  { path: 'Calgary/Calgary-SE/Auburn-Bay', component: AuburnBayComponent },
  { path: 'Calgary/Calgary-SE/Copperfield', component: CopperfieldComponent },
  { path: 'Calgary/Calgary-SE/Cranston', component: CranstonComponent },
  { path: 'Calgary/Calgary-SE/Douglasdale-Glen', component: DouglasdaleGlenComponent },
  { path: 'Calgary/Calgary-SE/EastShepard-Industrial', component: EastShepardIndustrialComponent },
  { path: 'Calgary/Calgary-SE/Mahogany', component: MahoganyComponent },
  { path: 'Calgary/Calgary-SE/McKenzie-Lake', component: McKenzieLakeComponent },
  { path: 'Calgary/Calgary-SE/McKenzie-Towne', component: McKenzieTowneComponent },
  { path: 'Calgary/Calgary-SE/NewBrighton', component: NewBrightonComponent },
  { path: 'Calgary/Calgary-SE/Ogden', component: OgdenComponent },
  { path: 'Calgary/Calgary-SE/Riverbend', component: RiverbendComponent },
  { path: 'Calgary/Calgary-SE/Seton', component: SetonComponent },
  { path: 'Calgary/Calgary-SE/Shepard-Industrial', component: ShepardIndustrialComponent },
  { path: 'Calgary/Calgary-SE/South-Foothills', component: SouthFoothillsComponent },
  
  { path: 'Calgary/Calgary-N/Beddington-Heights', component: BeddingtonHeightsComponent },
  { path: 'Calgary/Calgary-N/Carrington', component: CarringtonComponent },
  { path: 'Calgary/Calgary-N/Country-Hills', component: CountryHillsComponent },
  { path: 'Calgary/Calgary-N/Country-Hills-Village', component: CountryHillsVillageComponent },
  { path: 'Calgary/Calgary-N/Coventry-Hills', component: CoventryHillsComponent },
  { path: 'Calgary/Calgary-N/Evanston', component: EvanstonComponent },
  { path: 'Calgary/Calgary-N/Harvest-Hills', component: HarvestHillsComponent },
  { path: 'Calgary/Calgary-N/Hidden-Valley', component: HiddenValleyComponent },
  { path: 'Calgary/Calgary-N/Huntington-Hills', component: HuntingtonHillsComponent },
  { path: 'Calgary/Calgary-N/Kincora', component: KincoraComponent },
  { path: 'Calgary/Calgary-N/Livingston', component: LivingstonComponent },
  { path: 'Calgary/Calgary-N/Mac-Ewan-Glen', component: MacEwanGlenComponent },
  { path: 'Calgary/Calgary-N/Nolan-Hill', component: NolanHillComponent },
  { path: 'Calgary/Calgary-N/North-Haven', component: NorthHavenComponent },
  { path: 'Calgary/Calgary-N/North-Haven-Upper', component: NorthHavenUpperComponent },
  { path: 'Calgary/Calgary-N/Panorama-Hills', component: PanoramaHillsComponent },
  { path: 'Calgary/Calgary-N/Sage-Hill', component: SageHillComponent },
  { path: 'Calgary/Calgary-N/Sandstone-Valley', component: SandstoneValleyComponent },
  { path: 'Calgary/Calgary-N/Sherwood', component: SherwoodComponent },
  { path: 'Calgary/Calgary-N/Skyline-West', component: SkylineWestComponent },
  { path: 'Calgary/Calgary-N/Thorncliffe', component: ThorncliffeComponent },
  
  { path: 'Calgary/Calgary-E/Albert-Park-Radisson-Heights', component: AlbertParkRadissonHeightsComponent },
  { path: 'Calgary/Calgary-E/Applewood-Park', component: ApplewoodParkComponent },
  { path: 'Calgary/Calgary-E/Belvedere', component: BelvedereComponent },
  { path: 'Calgary/Calgary-E/Dover', component: DoverComponent },
  { path: 'Calgary/Calgary-E/Eastfield', component: EastfieldComponent },
  { path: 'Calgary/Calgary-E/Erin-Woods', component: ErinWoodsComponent },
  { path: 'Calgary/Calgary-E/Foothills', component: FoothillsComponent },
  { path: 'Calgary/Calgary-E/Forest-Heights', component: ForestHeightsComponent },
  { path: 'Calgary/Calgary-E/Forest-Lawn', component: ForestLawnComponent },
  { path: 'Calgary/Calgary-E/Forest-Lawn-Industrial', component: ForestLawnIndustrialComponent },
  { path: 'Calgary/Calgary-E/Golden-Triangle', component: GoldenTriangleComponent },
  { path: 'Calgary/Calgary-E/Great-Plains', component: GreatPlainsComponent },
  { path: 'Calgary/Calgary-E/Penbrooke-Meadows', component: PenbrookeMeadowsComponent },
  { path: 'Calgary/Calgary-E/Red-Carpet', component: RedCarpetComponent },
  { path: 'Calgary/Calgary-E/Southview', component: SouthviewComponent },
  { path: 'Calgary/Calgary-E/Starfield', component: StarfieldComponent },
  { path: 'Calgary/Calgary-E/Valleyfield', component: ValleyfieldComponent },

  { path: 'Calgary/Calgary-S/Acadia', component: AcadiaComponent },
  { path: 'Calgary/Calgary-S/Bayview', component: BayviewComponent },
  { path: 'Calgary/Calgary-S/Bonavista-Downs', component: BonavistaDownsComponent },
  { path: 'Calgary/Calgary-S/Braeside', component: BraesideComponent },
  { path: 'Calgary/Calgary-S/Bridlewood', component: BridlewoodComponent },
  { path: 'Calgary/Calgary-S/Canyon-Meadows', component: CanyonMeadowsComponent },
  { path: 'Calgary/Calgary-S/Cedarbrae', component: CedarbraeComponent },
  { path: 'Calgary/Calgary-S/Chaparral', component: ChaparralComponent },
  { path: 'Calgary/Calgary-S/Chinook-Park', component: ChinookParkComponent },
  { path: 'Calgary/Calgary-S/Deer-Ridge', component: DeerRidgeComponent },
  { path: 'Calgary/Calgary-S/Deer-Run', component: DeerRunComponent },
  { path: 'Calgary/Calgary-S/Eagle-Ridge', component: EagleRidgeComponent },
  { path: 'Calgary/Calgary-S/East-Fairview-Industrial', component: EastFairviewIndustrialComponent },
  { path: 'Calgary/Calgary-S/Evergreen', component: EvergreenComponent },
  { path: 'Calgary/Calgary-S/Fairview', component: FairviewComponent },
  { path: 'Calgary/Calgary-S/Fairview-Industrial', component: FairviewIndustrialComponent },
  { path: 'Calgary/Calgary-S/Haysboro', component: HaysboroComponent },
  { path: 'Calgary/Calgary-S/Kelvin-Grove', component: KelvinGroveComponent },
  { path: 'Calgary/Calgary-S/Kingsland', component: KingslandComponent },
  { path: 'Calgary/Calgary-S/Lake-Bonavista', component: LakeBonavistaComponent },
  { path: 'Calgary/Calgary-S/Legacy', component: LegacyComponent },
  { path: 'Calgary/Calgary-S/Maple-Ridge', component: MapleRidgeComponent },
  { path: 'Calgary/Calgary-S/Midnapore', component: MidnaporeComponent },
  { path: 'Calgary/Calgary-S/Millrise', component: MillriseComponent },
  { path: 'Calgary/Calgary-S/Oakridge', component: OakridgeComponent },
  { path: 'Calgary/Calgary-S/Outof-Area-Calgary', component: OutofAreaCalgaryComponent },
  { path: 'Calgary/Calgary-S/Palliser', component: PalliserComponent },
  { path: 'Calgary/Calgary-S/Parkland', component: ParklandComponent },
  { path: 'Calgary/Calgary-S/Pine-Creek', component: PineCreekComponent },
  { path: 'Calgary/Calgary-S/Pump-Hill', component: PumpHillComponent },
  { path: 'Calgary/Calgary-S/Queensland', component: QueenslandComponent },
  { path: 'Calgary/Calgary-S/Shawnee-Slopes', component: ShawneeSlopesComponent },
  { path: 'Calgary/Calgary-S/Shawnessy', component: ShawnessyComponent },
  { path: 'Calgary/Calgary-S/Silverado', component: SilveradoComponent },
  { path: 'Calgary/Calgary-S/Somerset', component: SomersetComponent },
  { path: 'Calgary/Calgary-S/Southwood', component: SouthwoodComponent },
  { path: 'Calgary/Calgary-S/Sundance', component: SundanceComponent },
  { path: 'Calgary/Calgary-S/Walden', component: WaldenComponent },
  { path: 'Calgary/Calgary-S/Willow-Park', component: WillowParkComponent },
  { path: 'Calgary/Calgary-S/Woodbine', component: WoodbineComponent },
  { path: 'Calgary/Calgary-S/Woodlands', component: WoodlandsComponent },

  { path: 'Calgary/Calgary-W/Aspen-Woods', component: AspenWoodsComponent },
  { path: 'Calgary/Calgary-W/Christie-Park', component: ChristieParkComponent },
  { path: 'Calgary/Calgary-W/Coach-Hill', component: CoachHillComponent },
  { path: 'Calgary/Calgary-W/Cougar-Ridge', component: CougarRidgeComponent },
  { path: 'Calgary/Calgary-W/Crestmont', component: CrestmontComponent },
  { path: 'Calgary/Calgary-W/Currie-Barracks', component: CurrieBarracksComponent },
  { path: 'Calgary/Calgary-W/Discovery-Ridge', component: DiscoveryRidgeComponent },
  { path: 'Calgary/Calgary-W/Garrison-Green', component: GarrisonGreenComponent },
  { path: 'Calgary/Calgary-W/Glamorgan', component: GlamorganComponent },
  { path: 'Calgary/Calgary-W/Glenbrook', component: GlenbrookComponent },
  { path: 'Calgary/Calgary-W/Glendale', component: GlendaleComponent },
  { path: 'Calgary/Calgary-W/Lakeview', component: LakeviewComponent },
  { path: 'Calgary/Calgary-W/Lincoln-Park', component: LincolnParkComponent },
  { path: 'Calgary/Calgary-W/North-Glenmore-Park', component: NorthGlenmoreParkComponent },
  { path: 'Calgary/Calgary-W/Patterson', component: PattersonComponent },
  { path: 'Calgary/Calgary-W/Rosscarrock', component: RosscarrockComponent },
  { path: 'Calgary/Calgary-W/Rutland-Park', component: RutlandParkComponent },
  { path: 'Calgary/Calgary-W/Signal-Hill', component: SignalHillComponent },
  { path: 'Calgary/Calgary-W/Springbank-Hill', component: SpringbankHillComponent },
  { path: 'Calgary/Calgary-W/Spruce-Cliff', component: SpruceCliffComponent },
  { path: 'Calgary/Calgary-W/Strathcona-Park', component: StrathconaParkComponent },
  { path: 'Calgary/Calgary-W/Valley-Ridge', component: ValleyRidgeComponent },
  { path: 'Calgary/Calgary-W/West-Springs', component: WestSpringsComponent },
  { path: 'Calgary/Calgary-W/Westgate', component: WestgateComponent },
  { path: 'Calgary/Calgary-W/Wildwood', component: WildwoodComponent },

  { path: 'Calgary/Calgary-CC/Altadore', component: AltadoreComponent },
  { path: 'Calgary/Calgary-CC/Alyth-Bonnybrook', component: AlythBonnybrookComponent },
  { path: 'Calgary/Calgary-CC/Banff-Trail', component: BanffTrailComponent },
  { path: 'Calgary/Calgary-CC/Bankview', component: BankviewComponent },
  { path: 'Calgary/Calgary-CC/Bel-Aire', component: BelAireComponent },
  { path: 'Calgary/Calgary-CC/Beltline', component: BeltlineComponent },
  { path: 'Calgary/Calgary-CC/Bridgeland-Riverside', component: BridgelandRiversideComponent },
  { path: 'Calgary/Calgary-CC/Britannia', component: BritanniaComponent },
  { path: 'Calgary/Calgary-CC/Burns-Industrial', component: BurnsIndustrialComponent },
  { path: 'Calgary/Calgary-CC/Cambrian-Heights', component: CambrianHeightsComponent },
  { path: 'Calgary/Calgary-CC/Capitol-Hill', component: CapitolHillComponent },
  { path: 'Calgary/Calgary-CC/Chinatown', component: ChinatownComponent },
  { path: 'Calgary/Calgary-CC/Cliff-Bungalow', component: CliffBungalowComponent },
  { path: 'Calgary/Calgary-CC/Crescent-Heights', component: CrescentHeightsComponent },
  { path: 'Calgary/Calgary-CC/Downtown-Commercial-Core', component: DowntownCommercialCoreComponent },
  { path: 'Calgary/Calgary-CC/Downtown-East-Village', component: DowntownEastVillageComponent },
  { path: 'Calgary/Calgary-CC/Downtown-West-End', component: DowntownWestEndComponent },
  { path: 'Calgary/Calgary-CC/Eau-Claire', component: EauClaireComponent },
  { path: 'Calgary/Calgary-CC/Elbow-Park', component: ElbowParkComponent },
  { path: 'Calgary/Calgary-CC/Elboya', component: ElboyaComponent },
  { path: 'Calgary/Calgary-CC/Erlton', component: ErltonComponent },
  { path: 'Calgary/Calgary-CC/Garrison-Woods', component: GarrisonWoodsComponent },
  { path: 'Calgary/Calgary-CC/Greenview', component: GreenviewComponent },
  { path: 'Calgary/Calgary-CC/Highfield', component: HighfieldComponent },
  { path: 'Calgary/Calgary-CC/Highland-Park', component: HighlandParkComponent },
  { path: 'Calgary/Calgary-CC/Highwood', component: HighwoodComponent },
  { path: 'Calgary/Calgary-CC/Hillhurst', component: HillhurstComponent },
  { path: 'Calgary/Calgary-CC/Hounsfield-Heights-Briar-Hill', component: HounsfieldHeightsBriarHillComponent },
  { path: 'Calgary/Calgary-CC/Inglewood', component: InglewoodComponent },
  { path: 'Calgary/Calgary-CC/Killarney-Glengarry', component: KillarneyGlengarryComponent },
  { path: 'Calgary/Calgary-CC/Lower-Mount-Royal', component: LowerMountRoyalComponent },
  { path: 'Calgary/Calgary-CC/Manchester', component: ManchesterComponent },
  { path: 'Calgary/Calgary-CC/Manchester-Industrial', component: ManchesterIndustrialComponent },
  { path: 'Calgary/Calgary-CC/Mayfair', component: MayfairComponent },
  { path: 'Calgary/Calgary-CC/Meadowlark-Park', component: MeadowlarkParkComponent },
  { path: 'Calgary/Calgary-CC/Mission', component: MissionComponent },
  { path: 'Calgary/Calgary-CC/Mount-Pleasant', component: MountPleasantComponent },
  { path: 'Calgary/Calgary-CC/Parkdale', component: ParkdaleComponent },
  { path: 'Calgary/Calgary-CC/Parkhill', component: ParkhillComponent },
  { path: 'Calgary/Calgary-CC/Point-McKay', component: PointMcKayComponent },
  { path: 'Calgary/Calgary-CC/Ramsay', component: RamsayComponent },
  { path: 'Calgary/Calgary-CC/Renfrew', component: RenfrewComponent },
  { path: 'Calgary/Calgary-CC/Richmond', component: RichmondComponent },
  { path: 'Calgary/Calgary-CC/Rideau-Park', component: RideauParkComponent },
  { path: 'Calgary/Calgary-CC/Rosedale', component: RosedaleComponent },
  { path: 'Calgary/Calgary-CC/Rosemont', component: RosemontComponent },
  { path: 'Calgary/Calgary-CC/Roxboro', component: RoxboroComponent },
  { path: 'Calgary/Calgary-CC/Scarboro', component: ScarboroComponent },
  { path: 'Calgary/Calgary-CC/Scarboro-Sunalta-West', component: ScarboroSunaltaWestComponent },
  { path: 'Calgary/Calgary-CC/Shaganappi', component: ShaganappiComponent },
  { path: 'Calgary/Calgary-CC/South-Calgary', component: SouthCalgaryComponent },
  { path: 'Calgary/Calgary-CC/St-Andrews-Heights', component: StAndrewsHeightsComponent },
  { path: 'Calgary/Calgary-CC/Sunalta', component: SunaltaComponent },
  { path: 'Calgary/Calgary-CC/Sunnyside', component: SunnysideComponent },
  { path: 'Calgary/Calgary-CC/Tuxedo-Park', component: TuxedoParkComponent },
  { path: 'Calgary/Calgary-CC/Upper-Mount-Royal', component: UpperMountRoyalComponent },
  { path: 'Calgary/Calgary-CC/West-Hillhurst', component: WestHillhurstComponent },
  { path: 'Calgary/Calgary-CC/Windsor-Park', component: WindsorParkComponent },
  { path: 'Calgary/Calgary-CC/Winston-Heights-Mountview', component: WinstonHeightsMountviewComponent },
  
  { path: 'Calgary/Belmont', component: BelmontComponent },
  { path: 'Calgary/Stoney-1', component: Stoney1Component },
  { path: 'Calgary/Stoney-2', component: Stoney2Component },
  { path: 'Calgary/Wolf-Willow', component: WolfWillowComponent },
  { path: 'Calgary/Yorkville', component: YorkvilleComponent },
  { path: 'Calgary/ZZZ-Fake-Community', component: ZZZFakeCommunityComponent },
  
  { path: 'Airdrie', component: AirdrieComponent },
  { path: 'Airdrie/Airdrie-Meadows', component: AirdrieMeadowsComponent },
  { path: 'Airdrie/Bayside', component: BaysideComponent },
  { path: 'Airdrie/Baysprings', component: BayspringsComponent },
  { path: 'Airdrie/Big-Springs', component: BigSpringsComponent },
  { path: 'Airdrie/Buffalo', component: BuffaloRubComponent },
  { path: 'Airdrie/Canals', component: CanalsComponent },
  { path: 'Airdrie/Chinook-Gate', component: ChinookGateComponent },
  { path: 'Airdrie/Coopers-Crossing', component: CoopersCrossingComponent },
  { path: 'Airdrie/Downtown', component: DowntownComponent },
  { path: 'Airdrie/East-Lake-Industrial', component: EastLakeIndustrialComponent },
  { path: 'Airdrie/Edgewater', component: EdgewaterComponent },
  { path: 'Airdrie/Fairways', component: FairwaysComponent },
  { path: 'Airdrie/Gateway', component: GatewayComponent },
  { path: 'Airdrie/Hillcrest', component: HillcrestComponent },
  { path: 'Airdrie/Jensen', component: JensenComponent },
  { path: 'Airdrie/Kings-Heights', component: KingsHeightsComponent },
  { path: 'Airdrie/Kingsview-Industrial-Park', component: KingsviewIndustrialParkComponent },
  { path: 'Airdrie/Lanark', component: LanarkComponent },
  { path: 'Airdrie/Luxstone', component: LuxstoneComponent },
  { path: 'Airdrie/Meadowbrook', component: MeadowbrookComponent },
  { path: 'Airdrie/Midtown', component: MidtownComponent },
  { path: 'Airdrie/Morningside', component: MorningsideComponent },
  { path: 'Airdrie/Prairie-Springs', component: PrairieSpringsComponent },
  { path: 'Airdrie/Ravenswood', component: RavenswoodComponent },
  { path: 'Airdrie/Reunion', component: ReunionComponent },
  { path: 'Airdrie/Sagewood', component: SagewoodComponent },
  { path: 'Airdrie/Sierra-Springs', component: SierraSpringsComponent },
  { path: 'Airdrie/Silver-Creek', component: SilverCreekComponent },
  { path: 'Airdrie/South-Point', component: SouthPointComponent },
  { path: 'Airdrie/South-Wind-song', component: SouthWindsongComponent },
  { path: 'Airdrie/Stonegate', component: StonegateComponent },
  { path: 'Airdrie/Summerhill', component: SummerhillComponent },
  { path: 'Airdrie/The-Village', component: TheVillageComponent },
  { path: 'Airdrie/Thorburn', component: ThorburnComponent },
  { path: 'Airdrie/Williamstown', component: WilliamstownComponent },
  { path: 'Airdrie/Willowbrook', component: WillowbrookComponent },
  { path: 'Airdrie/Windsong', component: WindsongComponent },
  { path: 'Airdrie/Woodside', component: WoodsideComponent },
  { path: 'Airdrie/Yankee-Valley-Crossing', component: YankeeValleyCrossingComponent }, 
  { path: 'Airdrie/Cobblestone', component: CobblestoneComponent }, 
  { path: 'Airdrie/Croxford-Estates', component: CroxfordEstatesComponent }, 
  { path: 'Airdrie/Edmonton-Trail', component: EdmontonTrailComponent }, 
  { path: 'Airdrie/Hamilton-Greens', component: HamiltonGreensComponent }, 
  { path: 'Airdrie/Old-Town', component: OldTownComponent }, 
  { path: 'Airdrie/Ridgegate', component: RidgegateComponent }, 
  { path: 'Airdrie/Waterstone', component: WaterstoneComponent }, 
  { path: 'Airdrie/Yankee-Valley-Estates', component: YankeeValleyEstatesComponent },

  { path: 'Chestermere', component: ChestermereComponent },
  { path: 'Chestermere/East-Chestermere', component: EastChestermereComponent },
  { path: 'Chestermere/Kinniburgh', component: KinniburghComponent },
  { path: 'Chestermere/Lakeside-Greens', component: LakesideGreensComponent },
  { path: 'Chestermere/Lakeview-Landing', component: LakeviewLandingComponent },
  { path: 'Chestermere/Rainbow-Falls', component: RainbowFallsComponent },
  { path: 'Chestermere/The-Beaches', component: TheBeachesComponent },
  { path: 'Chestermere/The-Cove', component: TheCoveComponent },
  { path: 'Chestermere/West-Creek', component: WestCreekComponent },
  { path: 'Chestermere/Westmere', component: WestmereComponent },
  { path: 'Chestermere/Other-City-Towns', component: OtherCityTownsComponent },
  { path: 'Chestermere/Chelsea-CH', component: ChelseaCHComponent }, 
  { path: 'Chestermere/Chesterview-Estates', component: ChesterviewEstatesComponent }, 
  { path: 'Chestermere/Dawsons-Landing', component: DawsonsLandingComponent }, 
  { path: 'Chestermere/Lakepointe', component: LakepointeComponent }, 
  { path: 'Chestermere/McIvor', component: McIvorComponent },
