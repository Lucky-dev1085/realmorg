...
@Component({
  selector: 'app-mortgage-contact',
  templateUrl: './mortgage-contact.component.html',
  styleUrls: ['./mortgage-contact.component.css']
})
export class MortgageContactComponent implements OnInit {
  ...
  request_detail() {
    ...
    this.leadsService.saveLeads('mortgage', address, this.str_first_name, this.str_last_name, this.str_email, this.str_phone, this.str_msg, this.str_type, this.str_subtype).subscribe(
      data => {
        console.log(data);
